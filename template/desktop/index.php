...
<body style="overflow: hidden;" oncontextmenu="return core.contextmenu();">
	...
	<div id="menuwin">
		...
		<ul id="programs">
			<li><a href="#" onclick="ui.pathOpen.openIE('https://oss.lzu.edu.cn','<?php echo $L['my_document'];?>');">访问开源社区</a></li>
			<li><div id="leftspliter"></div></li>
			<li><a href="#" onclick="core.setting('help');">帮助文档</a></li>
			<li><a href="#" onclick="core.setting('about');">关于文档</a></li>
			<li><a href="#" onclick="core.setting('user');">系统设置</a></li>
			<li class="search"></li>
		</ul>
		<ul id="links">
			<li class="icon"></li>
