...
$L= array(
	...
	"copyright_desc"  			=>"ISCloud 是一款 KODExplorer 的自定制版本，本系统遵循 GNU GPLv2 开源",
	'copyright_contact'  			=>'如需索取源代码请访问兰州大学开源社区项目中心',
	"copyright_info"  			=>'Copyright © LZUOSS All rights reserved.',
	"copyright_pre"  			=>'Powered by ISCloud',
	"kod_name"  				=> "ISCloud",
	"kod_name_desc"  			=> "兰州大学信息安全私有云存储系统",
	"kod_power_by"  			=> " - Powered by ISCloud",
	"kod_name_copyright"  		=> "兰州大学信息安全私有云存储系统",
